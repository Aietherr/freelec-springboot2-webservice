...
import com.booktest.web.dto.PostsListResponseDto;
...
public class PostsService {
    ...
    public Long update(Long id, PostsUpdateRequestDto requestDto) {
        Posts posts = postsRepository.findById(id).orElseThrow(() -> new IllegalMonitorStateException("해당 게시글이 없습니다. id="+ id));
